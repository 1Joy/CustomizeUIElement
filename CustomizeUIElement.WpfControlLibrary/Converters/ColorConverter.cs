...
namespace CustomizeUIElement.WpfControlLibrary.Converters
{
    ...
    public class ColorConverter : IValueConverter
    {
        ...
        public static Color DefaultColor = Color.FromRgb(255, 255, 255);

        public static Color PrimaryColor = Color.FromRgb(24, 144, 255);
        public static Color PrimaryHoverColor = Color.FromArgb(1, 64, 169, 255);

        public static Color ErrorColor = Color.FromRgb(255, 77, 79);
        public static Color ErrorHoverColor = Color.FromArgb(1, 255, 120, 117);

        public static Color SuccessColor = Color.FromRgb(82, 196, 26);
        public static Color SuccessHoverColor = Color.FromArgb(1, 24, 144, 255);

        public static Color WarnColor = Color.FromRgb(250, 173, 20);
        public static Color WarnHoverColor = Color.FromRgb(24, 144, 255);
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (valueStr)
            {
                ...
                default: targetColor = DefaultColor; break;
            }
    ...
    public class ColorHoverConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (valueStr)
            {
                ...
                default: targetColor = ColorConverter.DefaultColor; break;
            }
            return new SolidColorBrush(targetColor);
        }
